...
if __name__=="__main__":
    ...
    logger.info("number of proxies that are still alive: {} out of {} proxies can reach twitter -> {}".format(len(proxies), len(proxy_list), args.output))
